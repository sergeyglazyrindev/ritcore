...
setup(
    ...
    license='MIT',
    install_requires=['wheezy.web[mako]==0.1.485', 'nose==1.3.7',
                      'lxml==3.4.4', 'uWSGI==2.0.11.1', 'SQLAlchemy==1.0.8',
                      'Jinja2==2.8', 'pg8000==1.10.2',
    ...
    zip_safe=False,
    packages=['rit.core', ],
    scripts=['bin/notifyprojectchanged.sh', 'bin/rit-admin.py',
             'bin/runcompass.sh', 'bin/start_work_on_project.sh']
)
